...
public class BTInputKeyCodes {
   public static final int FUTURE_MAX_KEYCODE = 210;
   ...
   public static String interpretKeyEvent(String var0, String var1, KeyEvent[] var2) {
      String var3 = var0 + " ";
      int var4 = var2.length;
      int var5 = 0;

      String var8;
      for(int var6 = 0; var5 < var4; var3 = var8) {
         String var7;
         switch(var2[var5].getKeyCode()) {
         case 19:
            var7 = "Up";
            break;
         case 20:
