...
public class AppDescriptionListListenerBinder extends IAppDescriptionListListener.Stub {
   private ListenerBinderHelper binderHelper;

   public AppDescriptionListListenerBinder(OuyaResponseListener var1) {
